...
PaloAlto.initSections = function() {
  ...
  sections.register('featured-offerings', PaloAlto.FeaturedOfferings);
...
PaloAlto.FeaturedOfferings = (function() {
  var selectors = {
    parallaxImg: '[data-parallax-img]',
  };

  function FeaturedOfferings(container) {
    this.container = container;
    this.$container = $(container);
    this.enableParallax = this.container.hasAttribute('data-parallax-wrapper');
    this.sectionId = this.$container.attr('data-section-id');
  ...
  FeaturedOfferings.prototype = $.extend({}, FeaturedOfferings.prototype, {
    init: function() {
      if (!this.enableParallax) { return; }

      const inner = this.container.querySelector(selectors.parallaxImg);
      const frame = '#FeaturedOfferings--' + this.sectionId;
